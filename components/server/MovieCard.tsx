...
export default function MovieCard({ movie }: MovieCardProps) {
  ...
  return (
    <Link
      href={`/movie/${movie.id}`}
      className="group relative block overflow-hidden rounded-md bg-[#181818] transition-all duration-300 hover:scale-105 hover:z-30 hover:shadow-2xl hover:shadow-black/80"
    >
      ...
      <div className="relative aspect-[2/3] w-full bg-[#202020]">
        ...
        <div className="absolute top-1.5 left-1.5 font-black text-xs text-[#E50914] drop-shadow select-none">
          N
        </div>
      ...
      <div className="p-2 sm:p-2.5 bg-[#181818] space-y-1">
        <h3
          className="truncate font-bold text-xs sm:text-sm text-white group-hover:text-[#E50914] transition-colors"
          title={movie.title}
        >
          {movie.title}
        </h3>
